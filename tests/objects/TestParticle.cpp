...
// Test equality of two particles when generating a second particle via copy.
TEST(ParticleTests, EqualityByCopy) {
    constexpr std::array x{1.0, 2.0, 3.0};
...
// Test equality of two particles when generating a second particle using explicit attributes.
TEST(ParticleTests, EqualityByValues) {
    constexpr std::array x{1.0, 2.0, 3.0};
    constexpr std::array v{4.0, 5.0, 6.0};
    constexpr std::array f{7.0, 8.0, 9.0};
    constexpr double m = 10.0;
