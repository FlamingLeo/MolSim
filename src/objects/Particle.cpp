...
Particle::Particle(const Particle &other)
    ...
    std::cout << "Particle " << x << ", " << v << ", " << f << ", " << m << ", " << " generated by copy!" << std::endl;
}
...
Particle::~Particle() { std::cout << "Particle " << x << ", " << v << ", " << f << ", " << m << ", " << " destructed!" << std::endl; }
...
std::string Particle::toString() const {
    ...
    stream << "Particle: X:" << x << " v: " << v << " f: " << f << " old_f: " << old_f << " m: " << m << " type: " << type;
    return stream.str();
}
