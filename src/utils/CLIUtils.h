...
static inline void printHelp() {
    std::cout << "The PSE Molecular Dynamics simulation program, developed by "
                 "Group C.\n\n"
                 "USAGE: "
              << filename
              << " [options] <filename>\n"
                 "OPTIONS:\n"
                 "-s <number> : Sets the start time (decimal) for a specific "
                 "simulation (default: 0).\n"
                 "-e <number> : Sets the end time (decimal) for a specific "
                 "simulation (default: 1000).\n"
                 "-d <number> : Sets the time interval between two iterations "
                 "of a simulation (default: 0.014).\n"
                 "-f <number> : Sets the output frequency, i.e. after how many "
                 "iterations a new VTK file should be written (default: 10).\n"
                 "-h          : Prints out a help message. Doesn't perform any "
                 "simulation.\n";
}
 ...
 */
static inline void error(const char *msg, const std::string &opt = "",
                         bool usage = true, bool close = true) {
